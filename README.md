...
Locus is a **standard download, right here on GitHub** — no app store, no account required:

1. Open the **[Releases](https://github.com/blossommerz/locus-hub/releases)** page and pick the newest release.
2. Download the build for your platform — the **macOS** (`.dmg`) or the **Windows** installer.
...
> **Updates land here too.** Each new beta build is published on the same Releases page. **[Watch this repository](https://github.com/blossommerz/locus-hub)** (the *Watch* button, top-right) to hear when one goes out.

## 💬 Community & support

- **📣 Beta updates** — the public beta is live; email **[algoristanm@gmail.com](mailto:algoristanm@gmail.com)** to be looped in on new builds and announcements.
